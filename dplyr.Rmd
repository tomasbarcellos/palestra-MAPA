...
Se o interesse é o de ler dados externos estão começe escrevendo 'read' e teclando Shift. Surgirão várias funções para a leitura.
...
Escreva `read.csv2("")` e clique entre as aspas e tecle shift. Surgirá uma lista de arquivos disponíveis no seu WD.
```{r}
